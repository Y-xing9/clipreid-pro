...
# Clear3-Lite Configuration
_C.MODEL.FFN_EXPANSION = 2  # FFN expansion ratio: 2, 4, or 6
_C.MODEL.USE_MULTI_SCALE = False  # Use multi-scale features
_C.MODEL.USE_SE_MODULE = True  # Use SE attention module
_C.MODEL.DROPOUT_RATE = 0.1  # Dropout rate
